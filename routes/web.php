...
Route::prefix('reportes')->name('reportes.')->middleware(['auth'])->group(function () {
    ...
    Route::get('/marcas-diario', [ReportController::class, 'marcasDiario'])->name('marcas_diario');

    // ✅ corregidos:
    Route::get('/por-trabajador', [ReportController::class, 'reportePorTrabajador'])->name('ausencias.trabajador');
    Route::get('/general_mes',    [ReportController::class, 'reporteGeneralPorMes'])->name('ausencias.general');
});
